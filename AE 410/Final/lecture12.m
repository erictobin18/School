...
% construct FD matrix
PeriodicFlag = 0;
D_plus  = sparse(  upwind_3rd_order(x,PeriodicFlag));
D_minus = sparse(downwind_3rd_order(x,PeriodicFlag));
...
[t,q] = ode45(@(t,q) lecture12_euler_ODE_upwind(t,q,N,gamma,D_plus,D_minus),t_plot,q_0);
